...
const meta: Meta<typeof Graph> = {
  title: 'Design System/Components/Graph',
  component: Graph,
  parameters: {
    layout: 'padded',
    docs: {
  ...
  argTypes: {
    ...
    dataKeys: {
      control: false,
      description: 'Keys to extract from data objects for display',
      table: {
        disable: true,
        type: { summary: 'string[]' },
      },
...
export const LineChartMultiSeries: Story = {
  name: '02 Line Chart Multi Series',
  args: {
    type: 'line',
    data: monthlyData,
...
export const AreaChartWithGradient: Story = {
  name: '06 Area Chart With Gradient',
  args: {
    type: 'area',
    data: monthlyData,
