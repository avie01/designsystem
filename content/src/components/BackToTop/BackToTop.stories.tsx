...
const LongContent: React.FC = () => (
  <div style={{ minHeight: '200vh', padding: '40px' }}>
    ...
    <p>The button will appear once you scroll past 300 pixels from the top of the page.</p>
  ...
  render: () => (
    <div>
      <div style={{
        ...
        <strong>Scroll down more than 300px to see the Back to Top button appear in the bottom right</strong>
      </div>
      <LongContent />
      <BackToTop />
    </div>
    ...
    <div>
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', minHeight: '250vh' }}>
        <article>
          ...
          <h2>Key Features</h2>
          <ul>
            <li>Automatic visibility based on scroll position (appears after 300px)</li>
