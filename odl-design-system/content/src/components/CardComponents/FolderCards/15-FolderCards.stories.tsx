...
import FolderCards, { GridItem } from './FolderCards';
...
const meta: Meta<typeof FolderCards> = {
  title: 'Design System/Components/FolderCards',
...
export const WithStatusAndPriority: Story = {
  name: '06 With Status And Priority',
  args: {
    data: [
