...
const LeftNavigationDemo: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <DemoNavigation 
        ...
        description="Collapsible left sidebar navigation with icons and tooltips"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Left Navigation Rail</h2>
            ...
            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              <div className="flex h-64">
                <div className={clsx(
                  "bg-white rounded-l-lg transition-all duration-300",
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Realistic page layout with left navigation</p>
            </div>
              ...
              <div className="flex h-full">
                ...
                <div className="flex-1 bg-white p-6">
                  ...
                  <p className="text-sm text-gray-600">
                    This demonstrates how the Left Navigation Rail integrates with a full page layout. 
...
export default LeftNavigationDemo; 